...
2. 분석글 작성 시 "열심히 학습했습니다"와 같은 두루뭉술하고 상투적인 표현은 배제하고, 반드시 이미지 및 연동 데이터에서 판독된 **구체적인 수치(예: 평소 읽기속도 433자, 처음읽기 평균 380자, 다시읽기 476자, 소요시간 14분 6초, 이해도 97% 등)를 문장 내에 직접 명시**하여 정밀 분석을 제공해야 합니다.
3. 중요 지침 (내용의 풍부함과 여백 조절): 
   - 문장이 너무 축약되거나 짧으면 정보가 부실하여 신뢰감이 떨어지므로, 각 section의 text는 **핵심 데이터 분석과 전문적인 독서 교정 처방을 결합하여 4~5줄 내외(200자~280자 내외)로 내실 있게 집필**해 주세요.
