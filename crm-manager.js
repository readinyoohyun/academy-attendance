...
4. 문체는 "~하였습니다.", "~이 필요합니다.", "~을 권장합니다." 와 같이 학부모에게 신뢰감과 권위를 주는 정중하고 전문적인 어조(존댓말)여야 합니다.
   ...
   - 만약 리포트 형식이 '읽기 트레이닝 단독 분석 리포트' 인 경우:
     ...
     * introMessage: 학부모가 리포트를 열자마자 학생의 핵심 학업 상태를 한눈에 볼 수 있도록, 이미지에서 판독한 정량 수치(평소 읽기속도, 이해도, 처음/다시 읽기속도 및 목표 속도 등)를 문장 내에 직접 활용하여 작성한 3~4줄 내외의 데이터 기반 '종합 독서 성적 진단 및 원장 총평'으로 작성해야 합니다. 단순 완료 알림이나 '감사합니다/전달하겠습니다' 등의 상투적 문구는 전면 배제하고 데이터 중심의 전문 진단 코멘트를 서술해 주세요. (주의: 형제이름 언급 및 상투적인 인사말 절대 금지).
     * sections 배열:
